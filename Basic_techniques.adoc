...
NOTE: Currently Mason only expects clients to handle JSON encoding of simple data and "multipart/form-data" for file uploads. But future extensions (or internal extensions) might for instance use URL encoding for simple data and Zip for file uploads - or other better suited encodings.
...
In some cases it can also be useful to supply default values for the input data. 
