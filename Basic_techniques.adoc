...
=== How to supply default values for input data (TBD)
...
The client is expected to process this as follows:
  ...
  . Now merge the result back into the `template` object - overwrite with user input and keep the .... FIXME
